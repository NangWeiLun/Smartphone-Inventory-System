...
public class CustomerCartDialog extends JDialog implements ActionListener
{
	private static final long serialVersionUID = 1L;
	private JTextField txtName = new JTextField(10);
	private JButton btnSearch = new JButton("Search");
	private JButton btnUpdate = new JButton("Confirm");
	private JList<Customer> lstCustomers = new JList<>();
	private MainFrame mainframe;
	
	public CustomerCartDialog(MainFrame frame)
	{
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		else if (source == btnUpdate) 
		{
			...
			new ItemToCartDialog(mainframe,selected.getElementAt(lstCustomers.getSelectedIndex()));
		}
	}
}